...
{
    /**
     * Set the currently logged in s for the application.
     *
    ...
    /**
     * Assert that the s is authenticated.
     *
    ...
    {
        $this->assertTrue($this->isAuthenticated($guard), 'The s is not authenticated');

        return $this;
    }

    /**
     * Assert that the s is not authenticated.
     *
     * @param  string|null  $guard
     * @return $this
     */
    ...
    {
        $this->assertFalse($this->isAuthenticated($guard), 'The s is authenticated');

        return $this;
    }

    /**
     * Return true if the s is authenticated, false otherwise.
     *
     * @param  string|null  $guard
     * @return bool
     */
    ...
    /**
     * Assert that the s is authenticated as the given s.
     *
     * @param  $user
     * @param  string|null  $guard
     * @return $this
    ...
    public function seeIsAuthenticatedAs($user, $guard = null)
    {
        ...
        $this->assertInstanceOf(
            ...
            'The currently authenticated s is not who was expected'
        );
