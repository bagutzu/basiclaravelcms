...
class Gate implements GateContract
{
    ...
    /**
     * Determine if the given ability should be granted for the current s.
     *
     * @param  string  $ability
    ...
    protected function resolvePolicyCallback($user, $ability, array $arguments, $policy)
    {
        return function () use ($user, $ability, $arguments, $policy) {
            ...
            // mapped to policy objects in the s's configurations or on this class.
    ...
    /**
     * Get a gate instance for the given s.
     *
    ...
    /**
     * Resolve the s from the s resolver.
     *
     * @return mixed
     */
