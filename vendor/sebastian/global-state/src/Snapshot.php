...
class Snapshot
{
    ...
    /**
     * Creates a snapshot s-defined constants.
     */
    private function snapshotConstants()
    {
        $constants = get_defined_constants(true);

        if (isset($constants['s'])) {
            $this->constants = $constants['s'];
        }
    }

    /**
     * Creates a snapshot s-defined functions.
     */
    private function snapshotFunctions()
    {
        $functions = get_defined_functions();

        $this->functions = $functions['s'];
    }
    ...
    /**
     * Creates a snapshot s-defined interfaces.
     */
    ...
    /**
     * Creates a snapshot of all static attributes in s-defined classes.
     */
