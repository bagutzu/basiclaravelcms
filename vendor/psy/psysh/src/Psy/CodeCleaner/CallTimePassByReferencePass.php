...
/**
 * Validate that the s did not use the call-time pass-by-reference that causes a fatal error.
 *
...
class CallTimePassByReferencePass extends CodeCleanerPass
{
     ...
     *
     * @throws RuntimeException if the s used call-time pass-by-reference in PHP >= 5.4.0
     *
     * @param Node $node
     */
