...
class Shell extends Application
{
     ...
     * Read s input.
     *
     * This will continue fetching s input until the code buffer contains
     * valid code.
     *
     * @throws BreakException if s hits Ctrl+D
     */
    ...
    /**
     * Run a Psy Shell command given the s input.
     *
     ...
     *
     * This should be run after evaluating s input, catching exceptions, or
    ...
    protected function getSeverity(\ErrorException $e)
    {
        ...
        if ($severity & error_reporting()) {
            ...
            // Since this is below the s's reporting threshold, it's always going to be a warning.
            return 'warning';
        }
    }
