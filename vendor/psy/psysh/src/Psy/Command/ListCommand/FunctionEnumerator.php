...
class FunctionEnumerator extends Enumerator
{
     ...
     *
     * Optionally limit functions to "s" or "internal" functions.
     *
     * @param null|string $type "s" or "internal" (default: both)
     *
     * @return array
     */
    protected function getFunctions($type = null)
    {
        ...
        if ($type) {
            ...
            return array_merge($funcs['internal'], $funcs['s']);
        }
    }
