...
class StandardTagFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $context    = new Context('');
        $tagFactory = new StandardTagFactory(m::mock(FqsenResolver::class), ['s' => Author::class]);

        /** @var Author $tag */
        $tag = $tagFactory->create('@s Mike van Riel <me@mikevanriel.com>', $context);
     ...
     * @expectedExceptionMessage The tag "@s/myuser" does not seem to be wellformed, please check it for errors
     */
