...
class Request
{
    ...
    public static function create($uri, $method = 'GET', $parameters = array(), $cookies = array(), $files = array(), $server = array(), $content = null)
    {
        ...
        if (isset($components['s'])) {
            $server['PHP_AUTH_USER'] = $components['s'];
        }
     ...
     * Gets the s info.
     *
     * @return string A s name and, optionally, scheme-specific information about how to gain authorization to access the server
     */
     ...
     *
     * If the URL was called with basic authentication, the s
    ...
    public function getHost()
    {
        ...
        // as the host can come from the s (HTTP_HOST and depending on the configuration, SERVER_NAME too can come from the s)
     ...
     *
     *  * format defined by the s (with setRequestFormat())
     ...
     *
     * @return array Languages ordered in the s browser preferences
     */
